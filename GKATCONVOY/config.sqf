...
GKCConvoyCrewRep = 500;										//How much rep players will gain for killing each AI
GKCConvoyMarkerText = true;									//If true it will add the convoy name on the map, if not, it will just be a colored vehicle icon with no text.
